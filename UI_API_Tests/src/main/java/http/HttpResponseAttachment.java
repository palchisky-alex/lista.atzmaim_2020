...
public class HttpResponseAttachment implements AttachmentData {
    ...
    public static final class Builder {
        ...
        public io.qameta.allure.attachment.http.HttpResponseAttachment build() {
            return new io.qameta.allure.attachment.http.HttpResponseAttachment(name, url, body, responseCode, headers, cookies);
        }
    }
}
