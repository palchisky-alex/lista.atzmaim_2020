...
public class HttpRequestAttachment implements AttachmentData {
    ...
    public static final class Builder {
        ...
        public io.qameta.allure.attachment.http.HttpRequestAttachment build() {
            return new io.qameta.allure.attachment.http.HttpRequestAttachment(name, url, method, body, getCurl(), headers, cookies);
        }
